/**
 * this env extends react-env version 0.1.13.
 * to inspect its config @see https://bit.cloud/teambit/react/react-env?version=0.1.13
 * */
...
export class MvloansReactEnv extends ReactEnv {
  /* a shorthand name for the env */
  name = "mvloans-react-env";
...
export default new MvloansReactEnv();
